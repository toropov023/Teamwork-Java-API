...
public class Base64Coder {
    ...
    private static final char[] map1 = new char[64]; //Mapping table from 6-bit nibbles to Base64 characters
    private static final byte[] map2 = new byte[128]; //Mapping table from Base64 characters to 6-bit nibbles
